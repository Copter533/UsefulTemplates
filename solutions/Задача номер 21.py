...
# Найдите значение S при котором у Вани есть выигрышная стратегия позволяющая ему выиграть вторым ходом при любой игре
# Пети но у Вани нет стратегии которая позволяла бы ему гарантированно выиграть первым ходом.
